...
object FakeDataDummy {
    ...
    fun getDummyTvShows(): List<ItemListEntity> {
        return listOf(
            //1
            ItemListEntity(
            ...
            ItemListEntity(
                ...
                "en",
                "See",
                "/8TOkxONO3TEeJRuZWb0hG7SboyV.jpg",
                7.6,
                "See",
                "2019-11-01"
            ),
    ...
    fun getDataTv(): ArrayList<ItemEntity> {

        val tv = ArrayList<ItemEntity>()
        tv.add(
            ItemEntity(
                1,
                "Arrow",
